...
from quantlab.data.clean import build_price_panel
...
def fetch_clean_data(universe) -> pd.DataFrame:
    ...
    if processed_exists(universe_name):
        ...
        return build_price_panel(universe_name, raw_df)

# print(yf.download("AAPL", start="2020-01-01", auto_adjust=False).columns)
print(fetch_data_yf(dow_30(), "2020-01-01"))
print(fetch_clean_data(dow_30()))